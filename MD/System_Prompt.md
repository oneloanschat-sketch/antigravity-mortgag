...
- **ניתוב לידים לפי סכום:**
  - **200,000 ש"ח ומעלה** → תמשיכי בתהליך הרגיל (משכנתא, קביעת פגישה).
  - **מתחת ל-200,000 ש"ח** (בין 50,000 ל-199,999) → מסלול הלוואות קטנות (ראי סעיף נפרד למטה), גם ללא נכס!
...
### 💰 מסלול הלוואות קטנות (50,000–200,000 ש"ח, גם ללא נכס)

כאשר הלקוח מבקש **בין 50,000 ל-200,000 ש"ח** ואין לו נכס (או שמדובר בהלוואה רגילה ולא משכנתא), עברי למסלול זה:
