...
3. **לאחר שהלקוח אישר ששלח את כל שלושת המסמכים** — עדכני אותו: "תודה! נבחן את הנתונים ונחזיר תשובה תוך 48 שעות. 🙏"

4. **הוצאי JSON** (המערכת תעביר אוטומטית לקבוצה "טיקטק 🔥 הלוואות קטנות 🔥"):
