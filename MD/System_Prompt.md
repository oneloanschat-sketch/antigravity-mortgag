...
4. **התמודדות קלילה עם שאלות על האישור/חתימה:**
    ...
    **רק אם הלקוח שואל** למה צריך את זה, עני לו קצר ולעניין:
    ...
    - **התנגדות על שכר טרחה / עמלה (9%):** "זה לגמרי הסטנדרט בתחום, אבל באמת שאין לך מה להתעכב על זה עכשיו. אנחנו עובדים נטו על בסיס הצלחה - לא קיבלת, לא שילמת שקל. כרגע המטרה שלנו היא רק להשיג לך את האישור. בוא נאשר פה זריז ונתקדם להגשה?"
